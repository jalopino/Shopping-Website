            ...
            <div class="col-sm-12">
                <table border="1" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="process.approve.php?action=approve&transaction_ID=<?php echo $get_category["ID"] ?>">Approved</a> / 
                                <a href="process.Reject.php?action=reject&transaction_ID=<?php echo $get_category["ID"] ?>">Reject</a>
